...
public class ReeferTest {
	...
	public void setUp() {
		...
		reefer = new Reefer("REF001", 2.4, 6.0, 2.6, 12000, carga);
	}
	...
	public void diferentesReeferConDiferentesDimensionesTest() {
		Reefer reefer2 = new Reefer("REF002", 3.0, 6.0, 2.6, 15000, carga);
	...
	public void getVolumenConDimensionesCeroTest() {
		Reefer reeferCero = new Reefer("REF000", 0, 0, 0, 0, carga);
