...
public class CriterioMenorPrecioTest {
	...
	private CriterioMenorPrecio criterio;
	...
	@Test
	public void buscarMejorCircuitoPorPrecioTest() {
		...
		when(circuito1.precioEntreTerminales(origen, destino)).thenReturn(500.0);
		when(circuito2.precioEntreTerminales(origen, destino)).thenReturn(300.0);
		when(circuito3.precioEntreTerminales(origen, destino)).thenReturn(400.0);
